...
# Function to generate Thue-Morse sequence
...
def generate_plots(event=None):
    ...
    ax1.set_title("Input Dataframe (Thue-Morse Sequence)")
    ...
    ax2.set_title("FFT of Thue-Morse Sequence")
...
root = Tk()
root.title("Thue-Morse Sequence Plot Generator")
